...
import com.kursovaya.fxml_controllers.EnterController;
...
public class RequestController {
    ...
    public static ArrayList<MakeIDMail> GetSended() throws IOException,ClassNotFoundException{
        Client.ostream.writeObject(Constants.GET_SENDED);
        Client.ostream.writeObject(user.getId());

        ArrayList<MakeIDMail> cars=(ArrayList<MakeIDMail>)Client.istream.readObject();
        return cars;
    }

    public static ArrayList<MakeIDMail> GetIncoming() throws IOException,ClassNotFoundException{
    ...
    public static ArrayList<MMIDMail> GetIncoming_() throws IOException,ClassNotFoundException{
        Client.ostream.writeObject(Constants.GET_INCOMING_REQ);

        ArrayList<MMIDMail> cars=(ArrayList<MMIDMail>)Client.istream.readObject();
        return cars;
    }
    ...
    public static ArrayList<MMIDMail> GetAccepted() throws IOException,ClassNotFoundException{
        Client.ostream.writeObject(Constants.GET_ACCEPTED_REQ);
        Client.ostream.writeObject(user.getId());

        ArrayList<MMIDMail> accepted=(ArrayList<MMIDMail>)Client.istream.readObject();
        return accepted;
    }
