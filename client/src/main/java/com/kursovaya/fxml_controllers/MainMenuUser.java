...
public class MainMenuUser {
    ...
    @FXML
    private TableView<MakeIDMail> userIncomingRequest;
    @FXML
    private TableView<MakeIDMail> userSendedRequest;
    ...
    @FXML
    private TableColumn<MakeIDMail, String> makeColumn_2;
    @FXML
    private TableColumn<MakeIDMail, Integer> idColumn_2;
    @FXML
    private TableColumn<MakeIDMail, String> mailColumn_2;

    @FXML
    private TableColumn<MakeIDMail, String> makeColumn_21;
    @FXML
    private TableColumn<MakeIDMail, Integer> idColumn_21;
    @FXML
    private TableColumn<MakeIDMail, String> mailColumn_21;
    ...
    private ObservableList<MakeIDMail> SendedRequests = FXCollections.observableArrayList();
    private ObservableList<MakeIDMail> IncomingRequests = FXCollections.observableArrayList();
    ...
    public void initialize() throws IOException,ClassNotFoundException {
        ...
        ArrayList<MakeIDMail> sended=RequestController.GetSended();
        ArrayList<MakeIDMail> incoming=RequestController.GetIncoming();
        ...
        priceColumn.setCellValueFactory(new PropertyValueFactory<Car, Integer>("price"));
         ...
         makeColumn_21.setCellValueFactory(new PropertyValueFactory<MakeIDMail, String>("make"));
         idColumn_21.setCellValueFactory(new PropertyValueFactory<MakeIDMail, Integer>("id"));
         mailColumn_21.setCellValueFactory(new PropertyValueFactory<MakeIDMail, String>("mail"));

         makeColumn_2.setCellValueFactory(new PropertyValueFactory<MakeIDMail, String>("make"));
         idColumn_2.setCellValueFactory(new PropertyValueFactory<MakeIDMail, Integer>("id"));
         mailColumn_2.setCellValueFactory(new PropertyValueFactory<MakeIDMail, String>("mail"));
    ...
    void SendRequestOld(ActionEvent event) throws IOException,ClassNotFoundException {
        ...
        } else if (!InputCheck.validateMakeID(name))
    ...
    void SendRequestNew(ActionEvent event) throws IOException,ClassNotFoundException {
        ...
        if (name.isEmpty()) {
            EnterController.ThrowAlert("Error", "Error", "Something is empty");
        } else if (!InputCheck.validateMakeModel(name))
            EnterController.ThrowAlert("Error", "Error", "Wrong format");
        else {
